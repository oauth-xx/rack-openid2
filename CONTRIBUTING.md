...
- One spec file per class/module. For each class or module under `lib/`, keep all of its unit tests in a single spec file under `spec/` that mirrors the path and file name exactly: `lib/rack/openid2/my_class.rb` -> `spec/rack/openid2/my_class_spec.rb`.
...
[🧪build]: https://github.com/ruby-openid/rack-openid2/actions
