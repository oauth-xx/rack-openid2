...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/rack/openid/version.rb", mod) }::Rack::Version::VERSION
  else
...
Gem::Specification.new do |spec|
  ...
  spec.description = "💎 Provides a more HTTPish API around the ruby-openid2 library"
  spec.homepage = "https://github.com/ruby-openid/rack-openid2"
  spec.licenses = ["MIT"]
  ...
  spec.metadata["homepage_uri"] = "https://rack-openid2.galtzo.com"
